            ...
            <div className="h-full overflow-y-auto p-[1vw] space-y-[1vw]">
              {generatedTitles && generatedTitles?.length > 0 ? (
                generatedTitles?.map((title: any, index: any) => {
                  // Extract the title based on the type of generalTitle
                  const titleText = (() => {
                    const generalTitle = title.generalTitle;

                    // Handle string case
                    if (typeof generalTitle === "string") {
                      return generalTitle;
                    }

                    // Handle object case
                    if (generalTitle && typeof generalTitle === "object") {
                      const [firstValue] = Object.values(generalTitle);
                      if (firstValue && typeof firstValue === "string") {
                        return firstValue;
                      }
                    }
                    // Return empty string for invalid/unexpected formats
                    return "";
                  })();
          ...
          <CustomBtn
            ...
            onClick={() => {
              if (!selectedContentTitle) {
                ...
                router.push(
                  "/content-creator/create/movie-myth/generated-thumbnails",
                );
              }
            }}
          />
          ...
          <CustomBtn
            ...
            onClick={() => {
              if (!selectedContentTitle) {
                ...
                router.push("/content-creator/create/generated-thumbnails");
              }
            }}
          />
        )}
