...
import { socialMediaPostCreationContext } from "@/app/(authPaths)/social-media/post-creation/_context/socialMediaPostCreationContext";
    ...
    <div className={styles.post_view_screens + " flex gap-[1vw] h-[70%]"}>
      ...
      <div className={styles.desctop_screen + " w-2/3 h-full"}>
        ...
        <div className={styles.desctop_view}>
          ...
          <div className="flex-1 overflow-y-auto h-[30vh]">
            <p className="whitespace-pre-wrap">{postCaption}</p>
          </div>
        </div>
      </div>
