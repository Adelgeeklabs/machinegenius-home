...
import styles from "./AssignToListSelectInput.module.css";
...
const AssignToListSelectInput = (props: Iprops) => {
        ...
        <Box>
          <div className={`${styles.modalBox}`}>
            ...
            <div className="flex flex-col gap-[0.7vw]">
              <h4 className="font-semibold text-[20px]">Assign to new list</h4>
        ...
        >
          <div>
            ...
            >
              ...
              <span onClick={handleOpen}>Create New List</span>
            </div>
          </div>
...
export default AssignToListSelectInput;
