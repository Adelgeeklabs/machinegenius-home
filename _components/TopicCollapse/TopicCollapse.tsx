...
const TopicColapse = (props: IProps) => {
  ...
  useEffect(() => {
    if (props.hasCheckedArticles) {
      const hasCheckedArticles = props.hasCheckedArticles();
      setIsCollapseOpen(hasCheckedArticles);
    }
  }, []);

  return (
    <div
      className={`${styles.topic_collapse} topic_collapse ${
    ...
    >
      ...
      <div
        className={`${styles.collapse_header}  collapse_header`}
        ...
        <div>
          ...
          <div className="flex items-center gap-[0.5vw]">
            ...
            {props.forComments ? (
              <div
                className={
                  props.managerStatus === "online"
                    ? styles.onlineStatus
                    : props.managerStatus === "offline"
      ...
      <div
        className={
          props.replyTxt
            ? `${styles.collapse_body} flex flex-col gap-[0.4vw]`
            : styles.collapse_body
        }
      >
            ...
            <div>
              <div>
                ...
                <div className="flex items-center gap-[0.5vw]">
                  ...
                  <div
                    className={
                      props.ownerStatus === "online"
                        ? styles.onlineStatus
                        : props.ownerStatus === "offline"
                          ? styles.offlineStatus
                          : styles.awayStatus
                    }
                  >
          ...
          <div className="pt-[0.3vw]">
            <div>
              ...
              <input
                type="text"
                placeholder="Reply..."
                className={`${styles.replyInput} w-full`}
              />
            </div>
          </div>
        ) : null}
