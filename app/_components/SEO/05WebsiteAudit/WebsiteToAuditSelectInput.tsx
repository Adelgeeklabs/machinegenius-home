...
import styles from "./WebsiteToAuditSelectInput.module.css";
...
const WebsiteToAuditSelectInput = (props: Iprops) => {
  ...
  const [isWebpageChecked, setIsWebpageChecked] = useState(false); // State to track checkbox
  const handleCheckboxChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setIsWebpageChecked(event.target.checked);
  };
        ...
        <Box>
          <div className={`${styles.modalBox}`}>
            ...
            <div className="flex flex-col gap-[0.7vw]">
              <div className="flex">
                <CustomCheckBox accentColor="#EC6060" name="entire-website" />
                <label htmlFor="entire-website" className="font-bold">
              ...
              <div className="flex">
                ...
                <div className="flex flex-col">
                  <label htmlFor="webpage" className="font-bold">
                    Audit Webpage
                  </label>

                  {isWebpageChecked && (
                    <>
                      <label htmlFor="website-url" className="font-bold my-4">
                        Website URL*
                      </label>
                      <input
                        type="text"
...
export default WebsiteToAuditSelectInput;
