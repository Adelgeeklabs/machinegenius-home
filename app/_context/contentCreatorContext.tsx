...
const initialContextState = {
  ...
  selectedBrandId: "" as any,
  setSelectedBrandId: (brand: any) => {},
...
export default function ContentCreatorContextProvider({
  ...
  // ===== Start selectedBrandId =====
  function selectedBrandIdInit() {
    if (typeof window !== "undefined") {
      const selectedBrandIdInitValue =
        sessionStorage.getItem("selectedBrandId");
      return selectedBrandIdInitValue ? selectedBrandIdInitValue : "";
    } else {
      return "";
    }
  }
  const [selectedBrandId, setSelectedBrandId] =
    useState<any>(selectedBrandIdInit);
  useEffect(() => {
  ...
  async function generateTitles() {
    if (!selectedBrandId || !finalArticle?.articles[0]?.content) {
