...
export default function Home() {
  ...
  return (
    <>
      <div className="homePage w-full relative overflow-x-hidden text-[#FFFFFB] bg-[linear-gradient(180deg,_#2A2B2A_35%,_#5ea95bbd_100%)]">
        <Link
          href={"/"}
          className=" fixed top-1/3 translate-y-1/4 left-1/4 -translate-x-2/3 scale-[3] cursor-pointer z-[50000]"
          ref={logoRef}
        >
          <svg
            className=" w-[--128px]"
                ...
                <div className="flex gap-[--32px] w-full flex-wrap">
                  {businessData?.map((e, i) => {
                    return (
                      <div
                        key={i}
                        className="rounded-[--32px] bg-[#FFFFFB] text-[#2a2b2a] py-[--sy-48px] px-[--48px] hover:bg-[#5EA95B] w-[calc(50%_-_var(--32px))]"
                      >
