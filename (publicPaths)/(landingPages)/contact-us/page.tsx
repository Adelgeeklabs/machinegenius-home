      ...
      <div className=" w-full px-[--175px]">
        <div>
          <div className=" w-fit relative">
            <h2 className=" uppercase font-extrabold text-[--175px] text-[#FFFFFB] mb-[--sy-64px]">
              Contact <br />
              Us
            </h2>
                ...
                <div>
                  ...
                  <div className=" flex flex-col gap-[--sy-15px] text-[#FFFFFB] mb-[--sy-30px]">
                    ...
                    <textarea
                      ...
                      id="message"
                      placeholder="......"
                      className="resize-none rounded-[--6px] bg-[#FFFFFB] px-[--14px] py-[--sy-6px] text-[#2A2B2A] outline-none focus:outline-none"
                    />
                  </div>
                  <button className=" bg-[#FFFFFB] px-[--60px] py-[--sy-10px] font-bold text-[--20px] rounded-[--sy-7px] mx-auto block">
                    Submit
                  </button>
                </div>
              </div>
          ...
          <div className=" text-[#FFFFFB] mb-[--sy-680px]">
            ...
            <ul>
              <li>
                <Link href={"/"} className=" text-[--18px] leading-[--sy-28px]">
                  @Twitter
                </Link>
              </li>
              <li>
